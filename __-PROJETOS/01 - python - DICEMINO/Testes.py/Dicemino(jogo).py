...
while tabela:
    ...
    quantidadeDados = [0 for _ in range(7)] #lista para armazenar a quantidade de cada dado que será sorteada, o elemente [0] não será usado.
    ...
    while refazer:
                ...
                if puzzle[l][c] == 0:   # Confere se a posição está livre para adicionarmos uma peça
                    ...
                    if pecas[0] == 'X': 
                        ...
                        while True:
                            ...
                            if posicao == 1: # Se as condições forem verdadeiras a peça será adicionada na horizontal
                            ...
                            if posicao == 2: # Se as condições forem verdadeiras a peça será adicionada na horizontal
        ...
        for l in range(7):
            for c in range(7):  
                ...
                else:                # Se for diferente de 0 irá somar +1 em uma variável, que caso o total de peças seja 49 significa que não há nenhum
    ...
    for l in range (7):
        ...
        print('|               |               |               |               |               |               |               |')
        for c in range (7):
            print(f'|\t\033[47m\033[30m{puzzle[l][c]}\033[0m',end='\t')
        print('|',end='')
        if l==6:
            print('\n|               |               |               |               |               |               |               |')
            print('-----------------------------------------------------------------------------------------------------------------')
