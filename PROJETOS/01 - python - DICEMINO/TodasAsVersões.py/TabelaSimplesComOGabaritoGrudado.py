...
while tabela:
    ...
    while refazer:
        ...
        for l in range(0,7):
            for c in range(0,7):
                ...
                if puzzle[l][c] == 0:
                    ...
                    if pecas[0] == 'X': 
                         gabarito[l][c] = 'X' # Adicionando e colorindo no gabarito
                        ...
                        while True:
                            ...
                            if posicao == 1: # A peça de dominó será adicionada na horizontal
                            ...
                            if posicao == 2: # A peça de dominó será adicionada na vertical
        ...
        for l in range(7):
            for c in range(7):  
                if puzzle[l][c] == 0:
                    puzzle[l][c] = '\033[1;31m ERRO\033[0m' # Apenas uma precaução visual para casa ocorra um erro na correção da tabela, o erro estará vermelho
                    refazer = True 
